...
class RegionsListView(ListView):
    ...
    def get_queryset(self):
        ...
        queryset = (
            UzbRegions.objects.all()
            .values("id", "region_name_" + lang)
            .annotate(region_name=F("region_name_" + lang))
        )
        return queryset
...
class DistrictsListView(ListView):
    ...
    def get_queryset(self):
        ...
        queryset = (
            UzbDistricts.objects.filter(district_type=pk)
            .values("id", "district_name_" + lang)
